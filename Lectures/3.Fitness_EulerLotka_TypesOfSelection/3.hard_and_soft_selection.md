...
A[Initial Population: 200 Inds.]  
A --> H1[Habitat 1: 100 Parents]  
A --> H2[Habitat 2: 100 Parents]  

subgraph Hard Selection  
	H1 --> HS1[160 Survivors]  
	H2 --> HS2[40 Survivors]  
	HS1 --> HN[Next Generation<br/>200 Total]  
	HS2 --> HN  
end  

subgraph Soft Selection  
	H1 --> SS1[160 Survivors]  
	H2 --> SS2[40 Survivors] 
	SS1 --> SS11[reproduce: Produce 1600 offspring]  
	SS2 --> SS22[reproduce: Produce 400 offspring]  
	SS11 --> SQ1[carry capacity = 100]  
	SS22 --> SQ2[carry capacity = 100]  
	SQ1 --> SQQ1[100 Survive]  
	SQ2 --> SQQ2[100 Survive]  
	SQQ1 --> SN[Next Generation<br/>200 Total]  
	SQQ2 --> SN  
end  
